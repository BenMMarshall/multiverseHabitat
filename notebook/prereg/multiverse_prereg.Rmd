...
<!-- number of estimates -->
`r targets::tar_load("ssfResults"); targets::tar_load("areaResults"); dim(ssfResults)[1] + dim(areaResults)[1]`
```{r targetsParse, echo=FALSE}
# targets::tar_load(here("_targets", "objects", "areaResults"))
# targets::tar_load(here("_targets", "objects", "ssfResults"))
...
```
The datasets covered three virtual species, six individuals per species, frequencies from XX to XX locations per hour, and durations from XX to XX days.
