...
Here we explore using a multiverse approach how decisions concerning the design and analysis of an animal tracking study can impact the findings on habitat preference.
...
Using these setting we simulated 200 individuals of each species.
Each simulation contained of 1,051,200 time steps (i.e., movement choices made by the animal) comprising a dataset that represented two years worth of movement data.
<!-- Two years of simulation, one for model, second for validation -->
We split each individual's dataset into year 1 and 2, reserving year 2 data for validation purposes.
