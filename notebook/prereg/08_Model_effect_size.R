...
modOUT_dEstRSF <- brm(formula = formRSF,
                      ...
                      save_model = here("notebook", "modelOuput", "absDeltaEstModel_RSF.txt"),
                      file = here("notebook", "modelOuput", "absDeltaEstModel_RSF"))
...
modOUT_dEstWides <- brm(formula = formWides,
                        ...
                        seed = 1,
                        save_pars = save_pars(all = TRUE),
                        save_model = here("notebook", "modelOuput", "absDeltaEstModel_Wides.txt"),
                        file = here("notebook", "modelOuput", "absDeltaEstModel_Wides"))
...
modOUT_dEstSSF <- brm(formula = formSSF,
                      ...
                      seed = 1,
                      save_pars = save_pars(all = TRUE),
                      save_model = here("notebook", "modelOuput", "absDeltaEstModel_SSF.txt"),
                      file = here("notebook", "modelOuput", "absDeltaEstModel_SSF.txt"))
