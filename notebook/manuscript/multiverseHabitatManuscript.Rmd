...
The full parametrisation of the simulated species can be found in the code associated with this paper, specifically the simulate_individual.R function (available at: [https://github.com/BenMMarshall/multiverseHabitat](https://github.com/BenMMarshall/multiverseHabitat), and archived at: [Zenodo TBC](https://LINK)).
...
The code used to simulate the movement data, perform the multiverse, and analysis the results is available at: [https://github.com/BenMMarshall/multiverseHabitat](https://github.com/BenMMarshall/multiverseHabitat), and archived at [ZENODO LINK TBC](https://zenodo.org/).
