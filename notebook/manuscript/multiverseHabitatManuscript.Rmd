...
All models included individual and species as nested group effects, as well as a group effect accounting for whether the classified landscape was scrambled or not (for example, the formula for the SSF model looking at absolute deviation: absDeltaEst ~ 1 + tdScaled + tfScaled + modelForm + stepDist + turnDist + availablePerStepScaled + (1|classLandscape) + (1|species/indi)).
