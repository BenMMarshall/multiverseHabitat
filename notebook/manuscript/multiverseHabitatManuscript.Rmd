...
Dynamic Brownian Bridge Movement models were connected to the more variable estimates, and that variability did tended towards a lower estimates ($\beta$ `r brmrsf_rEst_dbmEffect`).
