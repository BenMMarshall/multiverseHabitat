...
The full parametrisation of the simulated species can be found in the code associated with this paper, specifically the simulate_individual.R function (available at: [multiverseHabitat Github: https://github.com/BenMMarshall/multiverseHabitat](https://github.com/BenMMarshall/multiverseHabitat), and archived at: [multiverseHabitat Zenodo: LINK](https://LINK)).
